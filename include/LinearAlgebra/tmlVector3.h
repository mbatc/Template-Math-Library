...
public:
  ...
  tmlVector3(T _x, const tmlVector2<T> &yz);
  tmlVector3(const tmlVector2<T> &xy, T _z);
  tmlVector3(const tmlVector3<T> &copy);
  tmlVector3(tmlVector3<T> &&move);

  template<typename T2> tmlVector3(T2 _x, T2 _y, T2 _z);
  template<typename T2> tmlVector3(T2 _x, const tmlVector2<T2> &yz);
  template<typename T2> tmlVector3(const tmlVector2<T2> &xy, T2 _z);
  ...
  tmlVector3<T> Add(const tmlVector3<T> &rhs) const;
  tmlVector3<T> Sub(const tmlVector3<T> &rhs) const;
  tmlVector3<T> Mul(const tmlVector3<T> &rhs) const;
  tmlVector3<T> Div(const tmlVector3<T> &rhs) const;
